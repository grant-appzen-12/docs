# <a id="_tvzo0ons6mhh"></a>__Introduction__
...
# <a id="_txw7fk1fvpku"></a>__Authentication __

This section explains the authentication available in both EA and AAP\.

## <a id="_z6uhlxa8xuar"></a>Authentication in EA
...
## <a id="_nc5gc94oij2d"></a>OAuth 1\.0 Authentication
...
## <a id="_a1pea4koxp13"></a>OAuth 2\.0 Authentication
...
## <a id="_fw5caj4g46o9"></a>OAuth2\.0 Self\-serve
...
## <a id="_3wyrcp8yewm6"></a>Request for OAuth 2\.0 token  
You need to generate an access token to AppZen's API gateway for authentication and validation\. For this, refer to Token Generation <Hyperlink> 
...
## <a id="_s5g5b7xl3n39"></a>FAQs on OAuth 2\.0
...
## <a id="_jcrf4ffk138w"></a>Authentication in AP
...
# <a id="_caf8eq951ups"></a>__Token Generation__
...
## <a id="_jmn0yosqbfem"></a>Request URI 

POST  https://api\.appzen\.com/api/v3/oauth2/token

## <a id="_vuliac5edw3b"></a>Body Parameters
...
__HTTP__ 		__Status__ 			    __Code Summary__
...
# <a id="_x48c9fnl3ycp"></a>__SSO__

## <a id="_61ps4676xrrs"></a>Introduction
...
## <a id="_582pl1b1qnzk"></a>Configuration
...
## <a id="_xpk681q1k7vz"></a>Sample Assertion Data
...
# <a id="_oy1u26310ozn"></a>CSV 

## <a id="_gr1phle0w749"></a>Introduction
...
## <a id="_gftvwkwvmrrl"></a>CSV Integration
...
## <a id="_lyg684bn3g20"></a>CSV \- SFTP Integration for Master Data and Employee Sync
...
## <a id="_mjrm9mhak9vn"></a>CSV Templates
